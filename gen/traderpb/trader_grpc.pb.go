...
type TraderClient interface {
	SubmitTrade(ctx context.Context, in *TradeRequest, opts ...grpc.CallOption) (*OrderResponse, error)
}
...
func (c *traderClient) SubmitTrade(ctx context.Context, in *TradeRequest, opts ...grpc.CallOption) (*OrderResponse, error) {
	out := new(OrderResponse)
	err := c.cc.Invoke(ctx, "/trader.Trader/SubmitTrade", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TraderServer interface {
	SubmitTrade(context.Context, *TradeRequest) (*OrderResponse, error)
...
func (UnimplementedTraderServer) SubmitTrade(context.Context, *TradeRequest) (*OrderResponse, error) {
...
func _Trader_SubmitTrade_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TradeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TraderServer).SubmitTrade(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/trader.Trader/SubmitTrade",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TraderServer).SubmitTrade(ctx, req.(*TradeRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Trader_SubmitTrade_Handler,
		},
	},
